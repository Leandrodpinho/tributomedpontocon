  ...
  return (
    ...
    >
      ...
      <CardHeader className="space-y-2">
        <div className="flex items-center gap-2 text-sm uppercase tracking-[0.2em] text-brand-100">
          <Award className="h-4 w-4" />
          Cenário Recomendado
        </div>
        <CardTitle className="text-2xl font-semibold text-slate-100 md:text-3xl">
      ...
      <CardContent className="space-y-6">
        <div className="grid gap-3 md:grid-cols-2">
          <div className="rounded-xl border border-[hsl(var(--accent))] bg-[hsl(var(--secondary))] p-4">
            <p className="text-xs uppercase tracking-wide text-brand-100">Carga Tributária</p>
            <p className="mt-2 text-2xl font-semibold text-slate-100">
              {formatCurrency(scenario.totalTaxValue)}
            </p>
            <Badge
              variant="secondary"
              className="mt-3 border-[hsl(var(--accent))] bg-[hsl(var(--accent)_/_0.18)] text-xs text-brand-100"
            >
          ...
          <div className="rounded-xl border border-emerald-400/60 bg-emerald-500/10 p-4">
            <p className="text-xs uppercase tracking-wide text-emerald-300">Lucro Líquido para Sócios</p>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <div className="flex flex-col gap-2 rounded-lg border border-[hsl(var(--accent))] bg-[hsl(var(--secondary))] p-3">
            ...
            {proLaboreAnalysis ? (
              ...
              <p className="text-sm text-slate-300">Sem informações de pró-labore.</p>
            )}
          </div>
          <div className="flex flex-col gap-2 rounded-lg border border-[hsl(var(--accent))] bg-[hsl(var(--secondary))] p-3">
            <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-brand-100">
